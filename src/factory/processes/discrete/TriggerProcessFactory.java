...
public abstract class TriggerProcessFactory extends ProcessFactory {
    public static TriggerProcessCoordinate instantiate(Element e, LayerManager layerManager, GeneralParameters p, int id) {
        ...
        return new TriggerProcessCoordinate(arguments, cpArguments, behaviorName, filter, skipVacant, requireNeighbors);
    }
}
